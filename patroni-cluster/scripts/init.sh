...
DB_URL="postgresql://${POSTGRES_USER}:${POSTGRES_PASSWORD}@/${POSTGRES_DB}"
...
sleep 5
psql -U postgres -d postgres -c "CREATE DATABASE construction_workers_db;"
psql -U postgres -d postgres -c "ALTER DATABASE construction_workers_db OWNER TO postgres;"

echo "RRRRRRRRRRRRRUNNNNNNNNNNNIIIIIIIINNNNNNGGGGGGGG SSSSCRIPTTTTTTTT"
